...
class ChartClassScreen extends StatefulWidget {
  const ChartClassScreen({Key? key, required this.classModel})
      : super(key: key);
...
class _ChartClassScreenState extends State<ChartClassScreen> {
  ...
  void fetchData() async {
    _fetchProgress = API(context).getDataChart(widget.classModel.classID ?? '');
            ...
            children: [
              Expanded(
                child: customBoxInformation(
                    'All', 'assets/icons/class.png', total, ChartType.column),
              ),
              const SizedBox(
                width: 40,
              ...
              Expanded(
                child: customBoxInformation(
                    'Pass', 'assets/images/course.png', pass, ChartType.column),
              ),
              const SizedBox(
                width: 40,
              ),
              Expanded(
                child: customBoxInformation(
                    'Ban', 'assets/icons/student.png', ban, ChartType.column),
              ),
              const SizedBox(
                width: 40,
              ),
              Expanded(
                child: customBoxInformation('Warning',
                    'assets/icons/lectuer.png', warning, ChartType.column),
              ),
            ],
          ),
        ),
              ...
              children: [
                Expanded(
                  child: customBoxInformation('Pass',
                      'assets/images/course.png', progressPass, ChartType.pie),
                ),
                const SizedBox(
                  width: 40,
                ),
                ...
                Expanded(
                  child: customBoxInformation('Ban', 'assets/icons/lectuer.png',

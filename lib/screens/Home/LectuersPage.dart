...
class LectuersPage extends StatefulWidget {
  const LectuersPage({super.key});

  @override
  State<LectuersPage> createState() => _LectuersPageState();
}

class _LectuersPageState extends State<LectuersPage> {
  TextEditingController searchInDashboardController = TextEditingController();
  int currentPage = 0;
  int studentsPerPage = 10;
  List<TeacherTest> listData = TeacherTest.listData();
  List<TeacherTest> listTemp = [];
  List<TeacherTest> searchResult = [];
  ...
  void searchTextChanged(String query) {
    ...
    List<TeacherTest> temp = listData;
  ...
  Table tableAttendance(List<TeacherTest> studentAttendance) {
  ...
  Widget showPage(List<TeacherTest> studentAttendance) {
    int startIndex = currentPage * studentsPerPage;

...
class TestPage extends StatefulWidget {
  ...
  @override
  State<TestPage> createState() => _StudentsPageState();
}

class _StudentsPageState extends State<TestPage> {
  ...
  List<Student> listData = [
    Student(
        studentID: '520H0696',
        studentName: 'Phan Anh Vu',
        studentEmail: '520H0696@student.tdtu.edu.vn'),
    Student(
        studentID: '520H00380',
        studentName: 'Ho Tuan Kiet',
        studentEmail: '520H00380@student.tdtu.edu.vn'),
    Student(
        studentID: '520H0697',
        studentName: 'Phan Anh Vu',
        studentEmail: '520H0697@student.tdtu.edu.vn'),
    Student(
        studentID: '520H00381',
        studentName: 'Ho Tuan Kiet',
        studentEmail: '520H00381@student.tdtu.edu.vn'),
    Student(
        studentID: '520H0698',
        studentName: 'Phan Anh Vu',
        studentEmail: '520H0698@student.tdtu.edu.vn'),
    Student(
        studentID: '520H00382',
        studentName: 'Ho Tuan Kiet',
        studentEmail: '520H00382@student.tdtu.edu.vn'),
  ];
  ...
  void exportToExcel(List<Student> studentAttendance) async {
    // Create Excel file
    ...
    sheet.appendRow([
      ...
      const excel.TextCellValue('Email')
    ]);
    ...
    for (int i = 0; i < studentAttendance.length; i++) {
      ...
      sheet.appendRow([
        excel.IntCellValue(i + 1), // No
        excel.TextCellValue(studentAttendance[i].studentID),
        excel.TextCellValue(studentAttendance[i].studentName),
        excel.TextCellValue(studentAttendance[i].studentEmail),
      ]);
    }
